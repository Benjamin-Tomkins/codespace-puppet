...
docker pull schoolofdevops/puppet-controller:v1.1.0
docker pull schoolofdevops/puppet-centos6-node:v1.3.0
docker pull schoolofdevops/puppet-ubuntu-node:v1.1
